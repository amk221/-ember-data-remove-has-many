...
module("Unit | Controller | application", function (hooks) {
  ...
  test("admin role should be removed from user #1", async function (assert) {
    assert.expect(2);
  ...
  test("admin role should be removed from user #2", async function (assert) {
    assert.expect(3);
  ...
  test("admin role should be removed from user #3", async function (assert) {
    assert.expect(1);
